...
public class WeekView extends View {
            ...
            if (mWidthPerDay + startPixel - start > 0){
                if (mShowDistinctPastFutureColor){
                    ...
                    if (sameDay){
                        ...
                        canvas.drawRect(startPixel + mWidthPerDay, startY, startPixel + mWidthPerDay + mColumnGap, getHeight(), mHourSeparatorPaint);
                    }
    ...
    /**
     * restart the view to be called after every button click to start from Monday
     */

    public void setIsFirstDraw(boolean value) {
        this.mIsFirstDraw = value;
        invalidate();
    }
